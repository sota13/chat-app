...
function RoomItem({id,name, description, last_massege, members, category}) {
  return (
    <div className="roomListRoom">
            <div className="roomListRoom__header">
            <Link to={`/chat-room/${id}`}>{name}</Link>
              <div className="roomListRoom__actions">
                <span>{last_massege}</span>
              </div>
            </div>
            ...
            <div className="roomListRoom__meta">
              <Link to={`/chat-room/${id}`} className="roomListRoom__joined">
              ...
              <p className="roomListRoom__topic">{category}</p>
            </div>
          </div>
  )
}
