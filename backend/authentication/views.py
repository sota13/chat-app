...
def test(request):
    token = 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ0b2tlbl90eXBlIjoiYWNjZXNzIiwiZXhwIjoxNjgxMzQwMDI2LCJpYXQiOjE2ODEwODA4MjYsImp0aSI6IjBhMDFiM2U1ZTJiMTRiOTM5MmNlMDdkYjYyYTZlODQ2IiwidXNlcl9pZCI6MX0.vZO7Un2ZaXda8MzZt_BUy-N99TnQUKPGdQbxUUGCV1w'
    secret = 'django-insecure-6n3vt+od7xvnqc9-=(25==5=-v*qz6dx^74-%_$dl-lrj69mdi'
    decoded_info = jwt.decode(token, secret, algorithms=["HS256"])
    user_id = decoded_info['user_id']
    user = User.objects.get(id=user_id)
    print(user.email)
    json_response = json.dumps({"message":"hey"})
